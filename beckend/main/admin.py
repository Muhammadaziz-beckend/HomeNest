...
class BookRegisterAdmin(admin.ModelAdmin):
    list_display = ('id','data_start','data_end','result_prise', 'prise','home' ,'user__phone','date_add')
    list_display_links = ('id','data_start','data_end','result_prise','prise','home','user__phone','date_add')
